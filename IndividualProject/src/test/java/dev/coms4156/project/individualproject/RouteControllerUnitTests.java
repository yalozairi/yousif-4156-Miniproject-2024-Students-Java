...
public class RouteControllerUnitTests {
  ...
  public static RouteController routeControllerTest;
  public static MyFileDatabase myFileDatabaseTest;

  @BeforeAll
  public static void setupRouteController() {
  ...
  public void setupDatabase() {
    ...
    myFileDatabaseTest = new MyFileDatabase(1, "./mock_data.txt");
    resetDataFile();
    IndividualProjectApplication.overrideDatabase(myFileDatabaseTest);


    //testCourseASE = new Course("Kaiser","interwebs", "tomorrow", 100);
    /*
    testCourseAP = new Course("Jae","columbia", "yesterday", 200);
    testCourseToBeAdded = new Course("Yousif","Home", "today!", 2);

    HashMap<String, Course> coursesHashMap = new HashMap<>();
    coursesHashMap.put("ASE", testCourseASE);
    coursesHashMap.put("AP", testCourseAP);

    HashMap<String, Department> departmentsHashMap = new HashMap<>();

    testDepartment = new Department("AAA", coursesHashMap, "Griffin Oldbold", 7);
    testEEDepartment = new Department("BBB", coursesHashMap, "Griffin Newbold", 92);

    departmentsHashMap.put("testDepartment", testDepartment);
    departmentsHashMap.put("testDepartment2", testEEDepartment);
  ...
  public static HashMap<String, Department> departmentHashMap;
